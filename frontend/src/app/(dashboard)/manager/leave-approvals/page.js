        ...
        <RoleProtectedRoute requiredRoles={['Manager']}>
            <div className="space-y-6">
                <div className="flex flex-col mb-8">
                    <h1 className="text-3xl font-bold tracking-tight mb-2" style={{ color: 'var(--text-primary)' }}>Team Leave Approvals</h1>
                    <p className="text-sm" style={{ color: 'var(--text-muted)' }}>Review and manage leave requests for your team.</p>
                </div>
