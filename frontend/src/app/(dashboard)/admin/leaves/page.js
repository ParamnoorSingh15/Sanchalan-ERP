        ...
        <RoleProtectedRoute requiredRoles={['Admin']}>
            <div className="space-y-6">
                <div className="flex flex-col mb-8">
                    <h1 className="text-3xl font-bold tracking-tight text-white mb-2">Leave Approvals</h1>
                    <p className="text-slate-400">Review and manage organizational leave requests.</p>
                </div>
